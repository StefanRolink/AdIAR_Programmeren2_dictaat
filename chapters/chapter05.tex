...
% Zodra de knop wordt ingedrukt (we lezen de status uit door \python{Rpi.GPIO.input()} aan te roepen op regel $2$), wordt er iets naar het scherm geschreven dat het gelukt is.
