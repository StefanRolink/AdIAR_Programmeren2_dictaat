...
\begin{exercise}
Breid het programma van opdracht \ref{exc:exc1} uit, zodat het programma je schreeuwend begroet: \textit{"HALLO, <NAAM>!"}. \newline
...
\begin{exercise}
Breid het programma van opdracht \ref{exc:exc1} uit, zodat het programma de gebruiker vraagt om achtereenvolgens z'n voornaam, achternaam, geslacht en leeftijd. \newline
