...
%	LINKS
%----------------------------------------------------------------------------------------
\definecolor{nhl_blue}{rgb}{0.05,0.41,0.69} 
\renewcommand\UrlFont{\color{blue}\rmfamily\itshape} 
\usepackage{hyperref}
\hypersetup{hidelinks,colorlinks=true,breaklinks=true,urlcolor=blue,bookmarksopen=false,linkcolor=nhl_blue,citecolor=blue,anchorcolor=blue}
