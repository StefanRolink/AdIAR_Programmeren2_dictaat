...
\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{NHL_cover_P2.pdf}};
...
% \noindent Copyright \copyright\ 2022 Stefan Rolink % Copyright notice
...
\noindent \textit{Versie 1.04, februari 2023} % Printing/edition date
